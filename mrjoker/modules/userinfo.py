...
import Villain.modules.sql.userinfo_sql as sql
from Villain import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of'Akay team'."
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThe Disaster level of this person is 'Villain'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        ...
        text += ' [<a href="https://telegra.ph/MRJOKER-LANGUAGE-CODES-06-03">?</a>]'.format(bot.username)
...
*What is that health thingy?*
 Come and see [HP System explained](https://telegra.ph/What-is-that-health-bar-that-MrJoker-displays-on-info-06-03)
"""
