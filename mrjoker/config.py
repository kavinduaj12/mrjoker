...
class Config(object):
    ...
    TOKEN = "1384019653:AAFuqfIuEDbMrd7srDkCk6hE7sX3AT95MmA"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgres://yhilzjlpptxvbm:a0799c569b0a0f4b8a50bfe20d0e4239bc892cea8080352c2261a041997c71da@ec2-34-193-101-0.compute-1.amazonaws.com:5432/daeup1r4dkkck7"  # needed for any database modules
    REDIS_URI = " "
    LOAD = []
    ...
    TIME_API_KEY = "1AW4Q9DTFF4F"  # Get your API key from https://timezonedb.com/api
    WALL_API = (
