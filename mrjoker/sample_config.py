...
class Config(object):
    ...
    TOKEN = "1384019653:AAEg-feyxmidzC8WFU9kILcRuQ36d65gBYI"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgresql://postgres:VbiyLNKIhkZ2K2H5Wo1g@containers-us-west-3.railway.app:6257/railway"  # needed for any database modules
    REDIS_URI = " "
    LOAD = []
